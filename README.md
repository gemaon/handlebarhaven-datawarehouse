...
The SQL queries that I designed to generate these business analytics insights can be viewed here: [/sql_scripts/business_analysis_queries.sql](business_analysis_queries.sql).
